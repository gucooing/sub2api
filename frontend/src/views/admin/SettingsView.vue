        ...
        <div class="card">
          ...
          <div class="space-y-5 p-6">
            ...
            <div v-if="form.affiliate_enabled" class="space-y-6">
              ...
              <div>
                <label class="input-label">
                  {{ t('admin.settings.features.affiliate.inviteBonus') }}
                </label>
                <input
                  v-model.number="form.affiliate_invite_bonus"
                  type="number"
                  step="0.01"
                  min="0"
                  class="input"
                ...
                />
                <p class="mt-1 text-xs text-gray-400">
                  {{ t('admin.settings.features.affiliate.inviteBonusDesc') }}
                </p>
              </div>
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      affiliate_invite_bonus: Math.max(0, Number(form.affiliate_invite_bonus) || 0),
