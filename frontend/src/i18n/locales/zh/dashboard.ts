export default {
  ...
  keys: {
    ...
    clickToEditGroups: '点击编辑分组（支持多分组回退）',
    editGroupsTitle: '编辑分组回退链',
    editGroupsHint: '拖拽排序，1 为主分组；同一平台最多 5 个。',
    groupChangedSuccess: '分组更换成功',
    failedToChangeGroup: '更换分组失败',
    groupRequired: '请至少选择一个分组',
    orderedGroupsHint:
      '拖拽调整顺序。请求按顺序尝试分组（1 = 主分组）。所有分组须为同一平台，最多 5 个。',
    addFallbackGroup: '添加分组',
    noGroupsSelected: '尚未选择分组',
    primaryGroup: '主分组',
    fallbackGroup: '回退',
    removeGroup: '移除分组',
    dragToReorder: '拖拽排序',
    samePlatformOnly: '仅可添加 {platform} 分组（由主分组锁定）',
    maxGroupsReached: '最多选择 {max} 个分组',
    fallbackCountTooltip: '{count} 个回退分组',
    usage: '用量',
    today: '今日',
    total: '近30天',
    quota: '额度',
