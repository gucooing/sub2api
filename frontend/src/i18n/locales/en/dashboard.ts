export default {
  ...
  keys: {
    ...
    groupLabel: 'Groups (ordered fallback)',
    ...
    clickToEditGroups: 'Click to edit groups (multi-group fallback supported)',
    editGroupsTitle: 'Edit group fallback chain',
    editGroupsHint: 'Drag to reorder. 1 = primary. Same platform, max 5.',
    ...
    orderedGroupsHint:
      'Drag to reorder. Requests try groups in order (1 = primary). All groups must share the same platform. Max 5.',
    addFallbackGroup: 'Add group',
    noGroupsSelected: 'No groups selected yet',
    primaryGroup: 'Primary',
    fallbackGroup: 'Fallback',
    removeGroup: 'Remove group',
    dragToReorder: 'Drag to reorder',
    samePlatformOnly: 'Only {platform} groups can be added (locked by primary group)',
    maxGroupsReached: 'Maximum of {max} groups reached',
    fallbackCountTooltip: '{count} fallback group(s)',
    usage: 'Usage',
    today: 'Today',
    total: 'Last 30d',
    quota: 'Quota',
