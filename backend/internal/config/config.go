...
func setDefaults() {
	...
	// Pricing - 从当前仓库同步模型定价和上下文窗口数据
	viper.SetDefault("pricing.remote_url", "https://raw.githubusercontent.com/gucooing/sub2api/main/backend/resources/model-pricing/model_prices_and_context_window.json")
	viper.SetDefault("pricing.hash_url", "https://raw.githubusercontent.com/gucooing/sub2api/main/backend/resources/model-pricing/model_prices_and_context_window.sha256")
