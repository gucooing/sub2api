...
//
// Keep this sanitizer minimal (upstream approach): only drop additional_tools.
// Do not rewrite custom_tool_call / freeform tools into function_call shapes —
// that breaks Codex tool routing and local shell execution.
